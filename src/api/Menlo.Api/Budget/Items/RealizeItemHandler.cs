...
public static class RealizeItemHandler
{
    public static async Task<IResult> Handle(
        Guid budgetId,
        Guid categoryId,
        Guid itemId,
        RealizeBudgetItemRequest request,
        ...
        CancellationToken cancellationToken)
    {
        ...
        Result<BudgetItem, BudgetError> result = budget.RealizeItem(budgetItemId, moneyResult.Value);
