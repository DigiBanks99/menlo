...
Research best-practices and ensure you are considering the #file:../../docs/reference/entity-design.md , #file:../../docs/explanations/architecture-document.md , #file:../../docs/explanations/concepts-and-terminology.md and other #file:../../docs/requirements when you need to clarify, need to find patterns and be consistent.
